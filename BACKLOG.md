...
| TASK-260429-24 | [프론트엔드] | [x] | Canvas 에디터 컴포넌트 구현 (동물 사진 + 텍스트/스티커 합성, canvas_state 직렬화) | TASK-260429-23 | 260429 / 260501 |
...
| TASK-260501-02 | [프론트엔드] | [ ] | 프론트엔드 API 클라이언트 구현 (Axios 인스턴스 + JWT Interceptor + POST /api/memes 연동) | - | 260501 / - |
