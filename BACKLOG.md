...
| TASK-260520-05 | [프론트엔드] | [x] | 블로그 공통 리소스(CSS/HTML) 중복 제거 및 프로필 카드 동기화 | - | post2/post4 코드블록 CSS 공통화 및 모든 개발 포스트(post2~4)에 프로필 카드 이식 완료 | 260520 / 260520 |
| TASK-260520-06 | [프론트엔드] | [ ] | 블로그 SEO(검색엔진 최적화) 고도화 및 유입 채널 다각화 | TASK-260520-04 | 정적 블로그의 검색 엔진 노출을 위한 meta 태그 개편, OpenGraph(OG) 적용, robots.txt 및 Sitemap.xml 설계 | 260520 / - |
