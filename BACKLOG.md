...
| TASK-260429-06 | [인프라/공통] | [x] | jOOQ Codegen Gradle 설정 및 인프라 레이어 연동 — Spring Data JPA로 대체, 현 규모에서 불필요 판단으로 제거 | - | 260429 / 260505 |
...
| TASK-260429-09 | [밈/이미지] | [x] | 밈 생성 및 전체/개별 조회 REST API 구현 — TASK-260429-20에서 완료 (POST /api/memes, GET /api/memes) | - | 260429 / 260501 |
...
| TASK-260429-31 | [프론트엔드] | [x] | 로그인 유도 모달 컴포넌트 구현 — LoginSlideMenu (SSO 버튼, 슬라이드 전환)로 구현 완료 | TASK-260429-29, TASK-260429-30 | 260429 / 260505 |
...
| TASK-260501-04 | [프론트엔드] | [x] | Canvas에 추가된 아이템의 크기(fontSize/stickerScale) 조절 UI 구현 — v2에서 Canvas 방식 자체 제거, CSS 말풍선으로 대체됨 | TASK-260429-24 | 260501 / 260505 |
...
| TASK-260504-05 | [하트/스테미나] | [x] | 하트 타입별 밈 조합 전략 서비스 (RandomMix / ContextualMatching) 구현 — MemeComposeService로 완료 | TASK-260504-03 | 260504 / 260504 |
| TASK-260504-06 | [밈/이미지] | [x] | 밈 조합 API 엔드포인트 구현 (GET /api/memes/compose) — MemeController에 완료 | TASK-260504-05 | 260504 / 260504 |
| TASK-260504-07 | [프론트엔드] | [x] | 모바일 퍼스트 메인 화면 재구축 (500px 컨테이너, BASIC/SPECIAL 하트 버튼) — main 반영 완료 | TASK-260504-06 | 260504 / 260505 |
| TASK-260504-08 | [프론트엔드] | [x] | CSS 말풍선 컴포넌트 구현 (subject_position 기반 절대 포지셔닝) — ResultScreen에 완료 | TASK-260504-07 | 260504 / 260505 |
| TASK-260504-09 | [프론트엔드] | [x] | SPECIAL 하트 태그 선택 UI 구현 (태그 멀티셀렉트 → 조합 요청 → 결과 표시) — TagSelectScreen으로 완료 | TASK-260504-07 | 260504 / 260505 |
| TASK-260504-10 | [프론트엔드] | [ ] | 로그인/서비스 소개 별도 화면 구현 (슬라이드 애니메이션 전환) | TASK-260504-07 | 260504 / - |
| TASK-260505-01 | [밈/이미지] | [x] | 밈 결과물 저장 기능 구현 (ResultScreen → html2canvas 캡처 → POST /api/memes → 갤러리 반영) | TASK-260504-08 | 260505 / 260505 |
